...
stat(const char *n, struct stat *st)
{
 ...
 23c:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 23e:	85ca                	mv	a1,s2
 240:	174000ef          	jal	3b4 <fstat>
 244:	892a                	mv	s2,a0
  close(fd);
 246:	8526                	mv	a0,s1
 248:	13c000ef          	jal	384 <close>
  return r;
 24c:	64a2                	ld	s1,8(sp)
}
 24e:	854a                	mv	a0,s2
