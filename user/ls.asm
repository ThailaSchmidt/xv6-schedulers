...
stat(const char *n, struct stat *st)
{
 ...
 3ba:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 3bc:	85ca                	mv	a1,s2
 3be:	174000ef          	jal	532 <fstat>
 3c2:	892a                	mv	s2,a0
  close(fd);
 3c4:	8526                	mv	a0,s1
 3c6:	13c000ef          	jal	502 <close>
  return r;
 3ca:	64a2                	ld	s1,8(sp)
}
 3cc:	854a                	mv	a0,s2
