...
stat(const char *n, struct stat *st)
{
 ...
 1b8:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1ba:	85ca                	mv	a1,s2
 1bc:	174000ef          	jal	330 <fstat>
 1c0:	892a                	mv	s2,a0
  close(fd);
 1c2:	8526                	mv	a0,s1
 1c4:	13c000ef          	jal	300 <close>
  return r;
 1c8:	64a2                	ld	s1,8(sp)
}
 1ca:	854a                	mv	a0,s2
