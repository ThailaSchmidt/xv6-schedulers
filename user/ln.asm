...
main(int argc, char *argv[])
{
  ...
  28:	698c                	ld	a1,16(a1)
  2a:	6488                	ld	a0,8(s1)
  2c:	2f4000ef          	jal	320 <link>
  30:	00054563          	bltz	a0,3a <main+0x3a>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  34:	4501                	li	a0,0
  36:	28a000ef          	jal	2c0 <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  3a:	6894                	ld	a3,16(s1)
  3c:	6490                	ld	a2,8(s1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a0:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1a2:	85ca                	mv	a1,s2
 1a4:	174000ef          	jal	318 <fstat>
 1a8:	892a                	mv	s2,a0
  close(fd);
 1aa:	8526                	mv	a0,s1
 1ac:	13c000ef          	jal	2e8 <close>
  return r;
 1b0:	64a2                	ld	s1,8(sp)
}
 1b2:	854a                	mv	a0,s2
