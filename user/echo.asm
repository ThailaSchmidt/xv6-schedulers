...
main(int argc, char *argv[])
{
  ...
  6e:	4505                	li	a0,1
  70:	29c000ef          	jal	30c <write>
    }
  }
  exit(0);
  74:	4501                	li	a0,0
  76:	276000ef          	jal	2ec <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1cc:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1ce:	85ca                	mv	a1,s2
 1d0:	174000ef          	jal	344 <fstat>
 1d4:	892a                	mv	s2,a0
  close(fd);
 1d6:	8526                	mv	a0,s1
 1d8:	13c000ef          	jal	314 <close>
  return r;
 1dc:	64a2                	ld	s1,8(sp)
}
 1de:	854a                	mv	a0,s2
