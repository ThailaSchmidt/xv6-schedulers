...
stat(const char *n, struct stat *st)
{
 ...
 3ac:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 3ae:	85ca                	mv	a1,s2
 3b0:	174000ef          	jal	524 <fstat>
 3b4:	892a                	mv	s2,a0
  close(fd);
 3b6:	8526                	mv	a0,s1
 3b8:	13c000ef          	jal	4f4 <close>
  return r;
 3bc:	64a2                	ld	s1,8(sp)
}
 3be:	854a                	mv	a0,s2
