...
stat(const char *n, struct stat *st)
{
 ...
 2ae:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 2b0:	85ca                	mv	a1,s2
 2b2:	174000ef          	jal	426 <fstat>
 2b6:	892a                	mv	s2,a0
  close(fd);
 2b8:	8526                	mv	a0,s1
 2ba:	13c000ef          	jal	3f6 <close>
  return r;
 2be:	64a2                	ld	s1,8(sp)
}
 2c0:	854a                	mv	a0,s2
