...
print(const char *s)
{
   ...
   a:	84aa                	mv	s1,a0
  write(1, s, strlen(s));
   c:	126000ef          	jal	132 <strlen>
  10:	0005061b          	sext.w	a2,a0
  14:	85a6                	mv	a1,s1
  16:	4505                	li	a0,1
  18:	352000ef          	jal	36a <write>
}
  1c:	60e2                	ld	ra,24(sp)
  1e:	6442                	ld	s0,16(sp)
  20:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  40:	3e800913          	li	s2,1000
    pid = fork(1);
  44:	4505                	li	a0,1
  46:	2fc000ef          	jal	342 <fork>
    if(pid < 0)
  4a:	04054363          	bltz	a0,90 <forktest+0x6a>
      break;
    if(pid == 0)
  4e:	cd09                	beqz	a0,68 <forktest+0x42>
  for(n=0; n<N; n++){
  50:	2485                	addiw	s1,s1,1
  52:	ff2499e3          	bne	s1,s2,44 <forktest+0x1e>
      exit(0);
  }
  ...
  5a:	3ea50513          	addi	a0,a0,1002 # 440 <uptime+0x5e>
  5e:	fa3ff0ef          	jal	0 <print>
    exit(1);
  62:	4505                	li	a0,1
  64:	2e6000ef          	jal	34a <exit>
      exit(0);
  68:	2e2000ef          	jal	34a <exit>
  }
  ...
  70:	39450513          	addi	a0,a0,916 # 400 <uptime+0x1e>
  74:	f8dff0ef          	jal	0 <print>
      exit(1);
  78:	4505                	li	a0,1
  7a:	2d0000ef          	jal	34a <exit>
    }
  }
  ...
  82:	39a50513          	addi	a0,a0,922 # 418 <uptime+0x36>
  86:	f7bff0ef          	jal	0 <print>
    exit(1);
  8a:	4505                	li	a0,1
  8c:	2be000ef          	jal	34a <exit>
  for(; n > 0; n--){
  90:	00905963          	blez	s1,a2 <forktest+0x7c>
    if(wait(0) < 0){
  94:	4501                	li	a0,0
  96:	2bc000ef          	jal	352 <wait>
  9a:	fc0549e3          	bltz	a0,6c <forktest+0x46>
  for(; n > 0; n--){
  9e:	34fd                	addiw	s1,s1,-1
  a0:	f8f5                	bnez	s1,94 <forktest+0x6e>
  if(wait(0) != -1){
  a2:	4501                	li	a0,0
  a4:	2ae000ef          	jal	352 <wait>
  a8:	57fd                	li	a5,-1
  aa:	fcf51ae3          	bne	a0,a5,7e <forktest+0x58>
  }

  print("fork test OK\n");
  ae:	00000517          	auipc	a0,0x0
  b2:	38250513          	addi	a0,a0,898 # 430 <uptime+0x4e>
  b6:	f4bff0ef          	jal	0 <print>
}
  ba:	60e2                	ld	ra,24(sp)
  bc:	6442                	ld	s0,16(sp)
  be:	64a2                	ld	s1,8(sp)
...
main(void)
{
  ...
  forktest();
  ce:	f59ff0ef          	jal	26 <forktest>
  exit(0);
  d2:	4501                	li	a0,0
  d4:	276000ef          	jal	34a <exit>
...
start()
{
  ...
  extern int main();
  main();
  e0:	fe7ff0ef          	jal	c6 <main>
  exit(0);
  e4:	4501                	li	a0,0
  e6:	264000ef          	jal	34a <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 22a:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 22c:	85ca                	mv	a1,s2
 22e:	174000ef          	jal	3a2 <fstat>
 232:	892a                	mv	s2,a0
  close(fd);
 234:	8526                	mv	a0,s1
 236:	13c000ef          	jal	372 <close>
  return r;
 23a:	64a2                	ld	s1,8(sp)
}
 23c:	854a                	mv	a0,s2
