...
main(int argc, char **argv)
{
  ...
  2c:	2ca000ef          	jal	2f6 <kill>
  for(i=1; i<argc; i++)
  30:	04a1                	addi	s1,s1,8
  32:	ff249ae3          	bne	s1,s2,26 <main+0x26>
  exit(0);
  36:	4501                	li	a0,0
  38:	28e000ef          	jal	2c6 <exit>
  3c:	e426                	sd	s1,8(sp)
  3e:	e04a                	sd	s2,0(sp)
    fprintf(2, "usage: kill pid...\n");
...
stat(const char *n, struct stat *st)
{
 ...
 1a6:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1a8:	85ca                	mv	a1,s2
 1aa:	174000ef          	jal	31e <fstat>
 1ae:	892a                	mv	s2,a0
  close(fd);
 1b0:	8526                	mv	a0,s1
 1b2:	13c000ef          	jal	2ee <close>
  return r;
 1b6:	64a2                	ld	s1,8(sp)
}
 1b8:	854a                	mv	a0,s2
